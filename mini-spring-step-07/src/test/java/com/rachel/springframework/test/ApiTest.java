...
import com.rachel.springframework.test.common.MyBeanFactoryPostProcessor;
import com.rachel.springframework.test.common.MyBeanPostProcessor;
import com.rachel.springframework.beans.factory.support.DefaultListableBeanFactory;
import com.rachel.springframework.beans.factory.xml.XmlBeanDefinitionReader;
...
public class ApiTest {
    ...
    public void test_xml() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            System.out.println("JVM is going to close!");
        }));
        try {
            Thread.sleep(2000);
